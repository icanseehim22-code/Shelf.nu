      ...
      >
        ...
        <When truthy={canUseBarcodes}>
          <FormRow
            rowLabel={"Barcodes"}
            className="border-b-0"
            subHeading="Add additional barcodes to this kit (Code 128, Code 39, or Data Matrix). Note: Each kit automatically gets a default EstoqueSoftSystem QR code for tracking."
          >
            <BarcodesInput
