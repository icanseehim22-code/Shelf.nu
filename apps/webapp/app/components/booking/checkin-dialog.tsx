...
export default function CheckinDialog({
  ...
  /**
   * We have to make sure the current time is before the `from` date of the booking. See details: https://github.com/EstoqueSoftSystem-nu/estoquesoftsystem.com/issues/1839
   */
